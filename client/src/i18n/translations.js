...
const translations = {
  ...
  'common.error': { bn: 'কিছু একটা সমস্যা হয়েছে।', en: 'Something went wrong.' },
  ...
  'common.deleteConfirm': { bn: 'আপনি কি নিশ্চিত এটি মুছে ফেলতে চান? এই কাজটি ফেরানো যাবে না।', en: 'Are you sure you want to delete this? This cannot be undone.' },
  ...
  'common.invalidEmail': { bn: 'সঠিক ইমেইল ঠিকানা দিন।', en: 'Please enter a valid email address.' },
  'common.viewOnGoogleMaps': { bn: 'Google Maps-এ দেখুন', en: 'View on Google Maps' },
  ...
  'common.empty.generic': { bn: 'এখনও কোনো তথ্য যুক্ত হয়নি।', en: 'No information has been added yet.' },
  'common.empty.admin': { bn: 'শীঘ্রই এখানে তথ্য যুক্ত করা হবে।', en: 'Information will be added here soon.' },

  // ----- Home -----
  'home.countdown.title': { bn: 'দুর্গাপূজা আসছে', en: 'Durga Puja is coming' },
  'home.countdown.subtitle': { bn: 'মহালয়ার অপেক্ষায় — প্রভাতের আলোয় প্রতিদিন নতুন প্রস্তুতি।', en: 'The countdown to the festivities has begun.' },
  ...
  'home.countdown.started': { bn: 'পূজা চলছে — শারদীয়ার শুভেচ্ছা!', en: 'The Puja is underway — warm festive greetings!' },
  'home.today.title': { bn: 'আজকের অনুষ্ঠান', en: "Today's Programme" },
  'home.today.empty': { bn: 'আজ কোনো নির্ধারিত অনুষ্ঠান নেই।', en: 'No programme is scheduled for today.' },
  'home.identity.eyebrow': { bn: 'আমাদের পরিচয়', en: 'Our Identity' },
  'home.identity.title': { bn: 'ঐতিহ্য ও সম্প্রদায়ের আঙিনা', en: 'A courtyard of heritage and community' },
  'home.identity.text': {
  ...
  'home.puja.eyebrow': { bn: 'আমাদের প্রাণের উৎসব', en: 'The festival of our hearts' },
  'home.puja.title': { bn: 'শারদীয় দুর্গোৎসব', en: 'The Autumn Durga Festival' },
  ...
  'home.committee.title': { bn: 'কার্যনির্বাহী কমিটি', en: 'Executive Committee' },
  ...
  'about.history.empty': { bn: 'ক্লাবের বিস্তারিত ইতিহাস শীঘ্রই প্রকাশিত হবে।', en: 'The detailed history of the club will be published soon.' },
  ...
  'puja.subtitle': { bn: 'শারদীয়ার আগমনী বার্তায় মেতে ওঠে গোটা পাড়া', en: 'The whole neighbourhood comes alive with autumn festivities' },
  ...
  'puja.empty': { bn: 'দুর্গাপূজার তথ্য শীঘ্রই প্রকাশিত হবে।', en: 'Durga Puja details will be published soon.' },
  'puja.schedule.empty': { bn: 'অনুষ্ঠানসূচি শীঘ্রই প্রকাশিত হবে।', en: 'The programme schedule will be published soon.' },
  ...
  'events.subtitle': { bn: 'ক্লাবের নিয়মিত ও বিশেষ অনুষ্ঠানসমূহ', en: 'Regular and special programmes of the club' },
  'events.empty': { bn: 'কোনো অনুষ্ঠান এখনও যুক্ত হয়নি।', en: 'No events have been added yet.' },
  ...
  'notices.subtitle': { bn: 'ক্লাবের সরকারি ঘোষণাসমূহ', en: 'Official announcements of the club' },
  'notices.empty': { bn: 'এই মুহূর্তে কোনো নোটিশ নেই।', en: 'There are no notices at the moment.' },
  ...
  'gallery.subtitle': { bn: 'উৎসব ও অনুষ্ঠানের মুহূর্ত', en: 'Moments from our festivals and events' },
  'gallery.empty': { bn: 'কোনো অ্যালবাম এখনও তৈরি হয়নি।', en: 'No albums have been created yet.' },
  'gallery.photos': { bn: 'টি ছবি', en: 'photos' },
  'gallery.albumEmpty': { bn: 'এই অ্যালবামে এখনও ছবি নেই।', en: 'This album has no photos yet.' },

  // ----- Videos -----
  'videos.title': { bn: 'ভিডিও', en: 'Videos' },
  'videos.subtitle': { bn: 'উৎসবের ভিডিও সংগ্রহ', en: 'A collection of festival videos' },
  'videos.empty': { bn: 'কোনো ভিডিও এখনও যুক্ত হয়নি।', en: 'No videos have been added yet.' },

  // ----- Committee -----
  'committee.title': { bn: 'কার্যনির্বাহী কমিটি', en: 'Executive Committee' },
  'committee.subtitle': { bn: 'ক্লাব পরিচালনায় নিয়োজিত', en: 'The office bearers of the club' },
  'committee.empty': { bn: 'কমিটির তথ্য শীঘ্রই প্রকাশিত হবে।', en: 'Committee details will be published soon.' },

  // ----- Members -----
  'members.title': { bn: 'সদস্য তালিকা', en: 'Members Directory' },
  'members.subtitle': { bn: 'ক্লাবের সদস্যবৃন্দ', en: 'The members of our club' },
  'members.empty': { bn: 'সদস্যদের তথ্য শীঘ্রই প্রকাশিত হবে।', en: 'Member details will be published soon.' },
  'members.searchPlaceholder': { bn: 'নাম বা পদবি খুঁজুন…', en: 'Search by name or designation…' },

  // ----- Social activities -----
  'social.title': { bn: 'সামাজিক কার্যক্রম', en: 'Social Activities' },
  'social.subtitle': { bn: 'সমাজসেবামূলক উদ্যোগসমূহ', en: 'Community welfare initiatives' },
  'social.empty': { bn: 'কোনো কার্যক্রমের তথ্য এখনও যুক্ত হয়নি।', en: 'No activities have been added yet.' },

  // ----- Mansa Mandir -----
  'mandir.title': { bn: 'মনসামাতা মন্দির', en: 'Mansa Mata Mandir' },
  'mandir.subtitle': { bn: 'আমাদের আদি ঐতিহ্য ও শ্রদ্ধার কেন্দ্র', en: 'Our ancestral heritage and centre of devotion' },
  ...
  'mandir.empty': { bn: 'মন্দির সম্পর্কিত বিস্তারিত তথ্য শীঘ্রই প্রকাশিত হবে।', en: 'Detailed information about the temple will be published soon.' },

  // ----- Memories -----
  'memories.title': { bn: 'স্মৃতিচারণ', en: 'Memories' },
  'memories.subtitle': { bn: 'বিগত বছরগুলোর স্মৃতি সংগ্রহ', en: 'A collection of memories from years gone by' },
  'memories.empty': { bn: 'কোনো স্মৃতি এখনও সংরক্ষিত হয়নি।', en: 'No memories have been archived yet.' },

  // ----- Souvenir -----
  'souvenir.title': { bn: 'সুভেনির', en: 'Souvenir' },
  'souvenir.subtitle': { bn: 'ক্লাবের স্মারকগ্রন্থ', en: 'The club’s commemorative publications' },
  'souvenir.empty': { bn: 'কোনো সুভেনির সংস্করণ এখনও যুক্ত হয়নি।', en: 'No souvenir editions have been added yet.' },
  'souvenir.edition': { bn: 'সংস্করণ', en: 'Edition' },
  'souvenir.viewPdf': { bn: 'PDF দেখুন', en: 'View PDF' },

  // ----- Contact -----
  'contact.title': { bn: 'যোগাযোগ', en: 'Contact Us' },
  'contact.subtitle': { bn: 'আপনার বার্তা আমাদের কাছে পাঠান', en: 'Send us your message' },
  ...
  'contact.success': { bn: 'আপনার বার্তা পৌঁছেছে। ধন্যবাদ!', en: 'Your message has been delivered. Thank you!' },

  // ----- Footer -----
  'footer.quickLinks': { bn: 'দ্রুত লিংক', en: 'Quick Links' },
  'footer.explore': { bn: 'আরও জানুন', en: 'Explore' },
  'footer.contact': { bn: 'যোগাযোগ', en: 'Contact' },
  'footer.copyright': { bn: 'সর্বস্বত্ব সংরক্ষিত।', en: 'All rights reserved.' },

  // ----- 404 -----
  'notfound.title': { bn: 'পৃষ্ঠাটি খুঁজে পাওয়া যায়নি', en: 'Page Not Found' },
  'notfound.text': { bn: 'আপনি যে পৃষ্ঠাটি খুঁজছেন সেটি সরানো হয়েছে বা বিদ্যমান নেই।', en: 'The page you are looking for has been moved or does not exist.' },
  'notfound.home': { bn: 'হোমপেজে ফিরে যান', en: 'Back to Home' },

  // ----- Admin: auth -----
  'admin.login.title': { bn: 'অ্যাডমিন লগইন', en: 'Admin Login' },
  'admin.login.subtitle': { bn: 'কন্টেন্ট ম্যানেজমেন্ট সিস্টেম', en: 'Content Management System' },
  ...
  'admin.login.failed': { bn: 'ইমেইল বা পাসওয়ার্ড ভুল হয়েছে।', en: 'Invalid email or password.' },
  ...
  'admin.dashboard.subtitle': { bn: 'ওয়েবসাইটের সাম্প্রতিক চিত্র', en: 'Your website at a glance' },
  ...
  'admin.list.empty': { bn: 'এখনও কোনো এন্ট্রি নেই। “নতুন যোগ করুন” থেকে শুরু করুন।', en: 'No entries yet. Start with “Add New”.' },
  ...
  'admin.form.pickImage': { bn: 'ছবি নির্বাচন / আপলোড', en: 'Choose / Upload image' },
  ...
  'admin.form.hintOrder': { bn: 'ছোট সংখ্যা আগে দেখাবে', en: 'Lower numbers appear first' },

  // ----- Admin: members -----
  'admin.members.showPhone': { bn: 'ফোন নম্বর প্রকাশ করুন', en: 'Show phone publicly' },
  'admin.members.showAddress': { bn: 'ঠিকানা প্রকাশ করুন', en: 'Show address publicly' },
  ...
  'admin.media.unused': { bn: 'কোথাও ব্যবহৃত হচ্ছে না', en: 'Not used anywhere' },
  'admin.media.inUseTitle': { bn: 'ফাইলটি ব্যবহৃত হচ্ছে', en: 'File is in use' },
  'admin.media.inUseText': { bn: 'এই ফাইলটি নিচের জায়গায় ব্যবহৃত হচ্ছে। মুছে ফেললে সেখানে ছবি দেখা যাবে না।', en: 'This file is referenced below. Deleting it will break those images.' },
  'admin.media.forceDelete': { bn: 'তবুও মুছুন', en: 'Delete anyway' },
  'admin.media.invalid': { bn: 'শুধুমাত্র JPEG, PNG, WebP বা GIF ছবি আপলোড করা যাবে।', en: 'Only JPEG, PNG, WebP or GIF images are allowed.' },
  'admin.media.tooLarge': { bn: 'ফাইলটি বড় — সর্বোচ্চ সীমা অতিক্রম করেছে।', en: 'File too large — exceeds the maximum size limit.' },
  ...
  // ----- Admin: settings -----
  'admin.settings.saved': { bn: 'সেটিংস সংরক্ষিত হয়েছে।', en: 'Settings saved.' },
  ...
  'admin.settings.homeSections': { bn: 'হোমপেজ সেকশন', en: 'Homepage Sections' },
  'admin.settings.addLink': { bn: 'লিংক যোগ করুন', en: 'Add link' },

  // ----- Admin: profile / security -----
  'admin.profile.title': { bn: 'প্রোফাইল ও নিরাপত্তা', en: 'Profile & Security' },
  'admin.profile.changePassword': { bn: 'পাসওয়ার্ড পরিবর্তন', en: 'Change Password' },
  'admin.profile.currentPassword': { bn: 'বর্তমান পাসওয়ার্ড', en: 'Current password' },
  'admin.profile.newPassword': { bn: 'নতুন পাসওয়ার্ড', en: 'New password' },
  'admin.profile.passwordChanged': { bn: 'পাসওয়ার্ড পরিবর্তিত হয়েছে।', en: 'Password changed successfully.' },
  'admin.profile.loggedInAs': { bn: 'লগইন করা আছে', en: 'Signed in as' },
  'admin.profile.lastLogin': { bn: 'সর্বশেষ লগইন', en: 'Last login' },
  'admin.profile.users': { bn: 'ব্যবহারকারী ব্যবস্থাপনা', en: 'User Management' },
  ...
  'admin.puja.startDate': { bn: 'শুরুর তারিখ (ষষ্ঠী)', en: 'Start date (Shashthi)' },
  'admin.puja.endDate': { bn: 'শেষ তারিখ (বিসর্জন)', en: 'End date (immersion)' },
  ...
  'admin.schedule.dayLabel': { bn: 'দিন (যেমন মহাষ্টমী)', en: 'Day (e.g. Maha Ashtami)' },
  'admin.schedule.addItem': { bn: 'সূচি যোগ করুন', en: 'Add schedule item' },
  'admin.schedule.selectPuja': { bn: 'পূজা নির্বাচন করুন', en: 'Select a puja' },
  ...
  'field.videoUrl': { bn: 'ভিডিও URL (YouTube / Vimeo)', en: 'Video URL (YouTube / Vimeo)' },
  ...
  'seo.siteTitle': { bn: 'গোস্বামীপাড়া মনসামাতা ক্লাব', en: 'Goswamipara Mansa Mata Club' },
};
